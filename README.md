...
Nous avons regrouper deux fichiers de données, celui de population et celui avec les prix au m2 pour voir si ces deux mouvements sont liés. En sélectionnant la population ,ainsi que le prix moyen, nous pouvons comparer l'un avec l'autre.
